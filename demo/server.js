...
//open a express server with socket.io  
const app = express();
...
io.on('connection', (socket) => {
  ...
  socket.on(socketEvents.DRAW_RECTANGLE,(data) => {
    io.sockets.emit(socketEvents.DRAW_RECTANGLE, data)
  });

  socket.on(socketEvents.DRAW_CIRCU,(data) => {
    io.sockets.emit(socketEvents.DRAW_CIRCU, data)
  });
  
  socket.on(socketEvents.CLEAR,(data) => {
    io.sockets.emit(socketEvents.CLEAR, data)
  });
